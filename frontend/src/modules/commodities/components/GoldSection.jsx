    ...
    <section className="panel">
      <div style={{ display: "flex", justifyContent: "space-between", gap: 16, alignItems: "flex-start", flexWrap: "wrap", marginBottom: 16 }}>
        ...
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
          <div style={{ minWidth: 150, padding: "10px 14px", borderRadius: 16, background: "rgba(255, 215, 0, 0.14)", border: "1px solid rgba(181, 137, 0, 0.18)" }}>
      ...
      <div style={{ height: 340 }}>
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={chartData} margin={{ top: 10, right: 8, left: 4, bottom: 0 }}>
            ...
            <Tooltip />
            <Line type="monotone" dataKey="price" name="Price" stroke="#b58900" dot={false} strokeWidth={2.5} />
            <Line type="monotone" dataKey="regression" name="Trend" stroke="#6b5d00" dot={false} strokeDasharray="6 4" />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </section>
