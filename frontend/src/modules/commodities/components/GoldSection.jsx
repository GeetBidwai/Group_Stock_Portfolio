    ...
    <section className="panel">
      <div style={{ display: "flex", justifyContent: "space-between", gap: 16, alignItems: "center", flexWrap: "wrap", marginBottom: 16 }}>
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
          <div style={{ padding: "12px 16px", borderRadius: 16, background: "rgba(255, 215, 0, 0.14)", border: "1px solid rgba(181, 137, 0, 0.18)" }}>
        ...
        <div style={{ height: 320 }}>
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={chartData}>
              ...
              <YAxis />
              <Tooltip />
              <Line dataKey="price" stroke="#b58900" dot={false} strokeWidth={2.5} />
              <Line dataKey="regression" stroke="#6b5d00" dot={false} strokeDasharray="6 4" />
            </LineChart>
          </ResponsiveContainer>
        </div>
        <div style={{ height: 320 }}>
          <ResponsiveContainer width="100%" height="100%">
            <ScatterChart>
              ...
              <Tooltip />
              <Scatter data={data.scatter_data || []} fill="#b58900" />
            </ScatterChart>
          </ResponsiveContainer>
        </div>
      </div>
