      ...
      <div style={{ height: 380 }}>
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={chartData} margin={{ top: 10, right: 12, left: -12, bottom: 0 }}>
            <XAxis dataKey="date" tick={{ fontSize: 12, fill: "#5f6b6d" }} tickLine={false} axisLine={false} />
            <YAxis tick={{ fontSize: 12, fill: "#5f6b6d" }} tickLine={false} axisLine={false} tickFormatter={(value) => `Rs ${formatCurrency(value)}`} width={88} />
